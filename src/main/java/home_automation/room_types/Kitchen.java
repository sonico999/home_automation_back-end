...
public class Kitchen extends ClassList  implements IRoom{
	...
	public LightApplication addLight(LightApplication light) {
		...
		Object arr[] = {light.getLightName(),light.getLightType(),kitchenName};
...
//	}
	...
	public Sensor addSensor(Sensor sensor) {
		...
		Object arr[] = {sensor.getSensorName(),sensor.getSensorType(),kitchenName};
	...
	public StepperApplication addStepper(StepperApplication stepper) {
		...
		logger.info("Adding sensor: {} to the {}",stepper.getStepperMotorName(),kitchenName);
		return stepper;
	}
	...
	public MotorApplication addMotor(MotorApplication motor){
		...
		logger.info("Adding motor: {} to the {}",motor.getMotorName(),kitchenName);
		return motor;
	}
