...
public class Bathroom extends ClassList implements IRoom {
	...
	public LightApplication addLight(LightApplication light) {
		...
		Object arr[] = {light.getLightName(),light.getLightType(),bathroomName};
	...
	public Sensor addSensor(Sensor sensor) {
		...
		Object arr[] = {sensor.getSensorName(),sensor.getSensorType(),bathroomName};
	...
	public StepperApplication addStepper(StepperApplication stepper) {
		...
		logger.info("Adding sensor: {} to the {}",stepper.getStepperMotorName(),bathroomName);
		return stepper;
	}
	@Override
	public MotorApplication addMotor(MotorApplication motor){
		...
		logger.info("Adding motor: {} to the {}",motor.getMotorName(),bathroomName);
		return motor;
	}
	...
	public ArrayList<Sensor> getBathroomSensor(){
		logger.info(Markers.GETTER,"Returning {} list of sensors",bathroomName);
