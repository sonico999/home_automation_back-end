...
public class Bedroom extends ClassList implements IRoom {
	...
	public LightApplication addLight(LightApplication light) {
		...
		Object arr[] = {light.getLightName(),light.getLightType(),bedroomName};
	...
	public Sensor addSensor(Sensor sensor) {
		...
		Object arr[] = {sensor.getSensorName(),sensor.getSensorType(),bedroomName};
	...
	public StepperApplication addStepper(StepperApplication stepper) {
		...
		logger.info("Adding sensor: {} to the {}",stepper.getStepperMotorName(),bedroomName);
		return stepper;
	}
	...
	public MotorApplication addMotor(MotorApplication motor){
		...
		logger.info("Adding motor: {} to the {}",motor.getMotorName(),bedroomName);
		return motor;
	}
