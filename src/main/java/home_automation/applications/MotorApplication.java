...
public class MotorApplication {
	...
	public MotorApplication(ArduinoCommunication AC, IRoom room, String motorName,
		...
		logger.info(Markers.CONSTRUCTOR,"Creating Motor Controller application instance");
	...
	public List<Integer> getports() {
		logger.info(Markers.GETTER,"Ports used: "+ports.get(0) +" "+ports.get(1));
		return ports;
	}
/**
 ...
 */
	...
	public boolean getState() {
		logger.info("{} is {}",motorName, direction ? "Clockwise" : "Anticlockwise");
		return direction;
	}
